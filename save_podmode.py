...
hmin = coor1[:,2].min()
num_steps = 4800
Train_steps = 4800# num_steps is the number of time steps
t = 0
...
data_filename = 'corelationmatrix_'+str(Nu2)+'.txt'
...
#for i in range (0,Train_steps):
    ...
    podmode.append(a)
    pod_filename = 'podmode_fenics_'+str(Nu2) +'.txt'
